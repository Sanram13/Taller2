...
public class ControlJuego {
    ...
    public ControlJuego(Fachada fachada) {
        vectorPuntaje = new int[13];  // Vector de tamaño 13 para los puntajes
    ...
    private void cargarPuntajesDesdeProperties() {
        ...
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("Propiedades.properties")) {
            if (input == null) {
