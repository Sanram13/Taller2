...
public class ControlJuego {
    ...
    public int lanzar() {
        int[] vectorPuntaje = {20, 20, 30, 30, 40, 40, 150, 150, 200, 300,0,0,0}; //Hola profe, estos son los puntajes, los 3 0s simbolizan si de plano bota el balin por fuera de la rana
    ...
    public void iniciarPartida() {
        ...
        else if(llegaronTemprano(this.numeroEquipo1,this.numeroEquipo2) == 1) { //Esto es cuando me pasen en el equipo
            if(this.fachada.getCequipo().estanCompletos(this.numeroEquipo1) && this.fachada.getCequipo().estanCompletos(this.numeroEquipo2)) {
                sorteoEquipoInicio();
                this.fachada.getCequipo().sorteoDeJugadoresEquipo(this.numeroEquipo1);
                this.fachada.getCequipo().sorteoDeJugadoresEquipo(this.numeroEquipo2);
                while (puntajeEquipo1 < 5000 && puntajeEquipo2 < 5000) {
                    for (int i = 0; i < 5; i++) {
                        for (int j = 0; j < 5; j++) {
